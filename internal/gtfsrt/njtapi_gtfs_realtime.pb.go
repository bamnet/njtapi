...
// MODIFIED COPY for github.com/bamnet/njtapi, from google/transit commit
// 474750a16308 (gtfs-realtime/proto/gtfs-realtime.proto). Only the proto
// package, the go_package option and the file name differ from upstream. They
// are renamed so this private copy never collides in the global protobuf
// registry with another copy of the bindings (package transit_realtime) linked
// into the same binary. The wire format is unchanged.

// Code generated by protoc-gen-go. DO NOT EDIT.
// versions:
// 	protoc-gen-go v1.36.11
// 	protoc        v7.35.1
// source: njtapi_gtfs_realtime.proto
...
func (FeedHeader_Incrementality) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[0].Descriptor()
}

func (FeedHeader_Incrementality) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[0]
}
...
func (FeedHeader_Incrementality) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{1, 0}
}
...
func (TripUpdate_StopTimeUpdate_ScheduleRelationship) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[1].Descriptor()
}

func (TripUpdate_StopTimeUpdate_ScheduleRelationship) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[1]
}
...
func (TripUpdate_StopTimeUpdate_ScheduleRelationship) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{3, 1, 0}
}
...
func (TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[2].Descriptor()
}

func (TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[2]
}
...
func (TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{3, 1, 0, 0}
}
...
func (VehiclePosition_VehicleStopStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[3].Descriptor()
}

func (VehiclePosition_VehicleStopStatus) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[3]
}
...
func (VehiclePosition_VehicleStopStatus) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{4, 0}
}
...
func (VehiclePosition_CongestionLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[4].Descriptor()
}

func (VehiclePosition_CongestionLevel) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[4]
}
...
func (VehiclePosition_CongestionLevel) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{4, 1}
}
...
func (VehiclePosition_OccupancyStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[5].Descriptor()
}

func (VehiclePosition_OccupancyStatus) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[5]
}
...
func (VehiclePosition_OccupancyStatus) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{4, 2}
}
...
func (Alert_Cause) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[6].Descriptor()
}

func (Alert_Cause) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[6]
}
...
func (Alert_Cause) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{5, 0}
}
...
func (Alert_Effect) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[7].Descriptor()
}

func (Alert_Effect) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[7]
}
...
func (Alert_Effect) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{5, 1}
}
...
func (Alert_SeverityLevel) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[8].Descriptor()
}

func (Alert_SeverityLevel) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[8]
}
...
func (Alert_SeverityLevel) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{5, 2}
}
...
const (
	...
	//
	// Deprecated: Marked as deprecated in njtapi_gtfs_realtime.proto.
...
func (TripDescriptor_ScheduleRelationship) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[9].Descriptor()
}

func (TripDescriptor_ScheduleRelationship) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[9]
}
...
func (TripDescriptor_ScheduleRelationship) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{8, 0}
}
...
func (VehicleDescriptor_WheelchairAccessible) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[10].Descriptor()
}

func (VehicleDescriptor_WheelchairAccessible) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[10]
}
...
func (VehicleDescriptor_WheelchairAccessible) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{9, 0}
}
...
func (Stop_WheelchairBoarding) Descriptor() protoreflect.EnumDescriptor {
	return file_njtapi_gtfs_realtime_proto_enumTypes[11].Descriptor()
}

func (Stop_WheelchairBoarding) Type() protoreflect.EnumType {
	return &file_njtapi_gtfs_realtime_proto_enumTypes[11]
}
...
func (Stop_WheelchairBoarding) EnumDescriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{14, 0}
}
...
func (x *FeedMessage) Reset() {
	*x = FeedMessage{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[0]
...
func (*FeedMessage) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{0}
}
...
type FeedHeader struct {
	...
	Incrementality      *FeedHeader_Incrementality `protobuf:"varint,2,opt,name=incrementality,enum=njtapi.internal.gtfsrt.FeedHeader_Incrementality,def=0" json:"incrementality,omitempty"`
...
func (x *FeedHeader) Reset() {
	*x = FeedHeader{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FeedHeader) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{1}
}
...
func (x *FeedEntity) Reset() {
	*x = FeedEntity{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FeedEntity) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{2}
}
...
func (x *TripUpdate) Reset() {
	*x = TripUpdate{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TripUpdate) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{3}
}
...
type VehiclePosition struct {
	...
	CurrentStatus *VehiclePosition_VehicleStopStatus `protobuf:"varint,4,opt,name=current_status,json=currentStatus,enum=njtapi.internal.gtfsrt.VehiclePosition_VehicleStopStatus,def=2" json:"current_status,omitempty"`
	// Moment at which the vehicle's position was measured. In POSIX time
	// (i.e., number of seconds since January 1st 1970 00:00:00 UTC).
	Timestamp       *uint64                          `protobuf:"varint,5,opt,name=timestamp" json:"timestamp,omitempty"`
	CongestionLevel *VehiclePosition_CongestionLevel `protobuf:"varint,6,opt,name=congestion_level,json=congestionLevel,enum=njtapi.internal.gtfsrt.VehiclePosition_CongestionLevel" json:"congestion_level,omitempty"`
	// If multi_carriage_status is populated with per-carriage OccupancyStatus,
	// then this field should describe the entire vehicle with all carriages accepting passengers considered.
	OccupancyStatus *VehiclePosition_OccupancyStatus `protobuf:"varint,9,opt,name=occupancy_status,json=occupancyStatus,enum=njtapi.internal.gtfsrt.VehiclePosition_OccupancyStatus" json:"occupancy_status,omitempty"`
...
func (x *VehiclePosition) Reset() {
	*x = VehiclePosition{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VehiclePosition) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{4}
}
...
type Alert struct {
	...
	Cause          *Alert_Cause      `protobuf:"varint,6,opt,name=cause,enum=njtapi.internal.gtfsrt.Alert_Cause,def=1" json:"cause,omitempty"`
	Effect         *Alert_Effect     `protobuf:"varint,7,opt,name=effect,enum=njtapi.internal.gtfsrt.Alert_Effect,def=8" json:"effect,omitempty"`
	...
	SeverityLevel      *Alert_SeverityLevel `protobuf:"varint,14,opt,name=severity_level,json=severityLevel,enum=njtapi.internal.gtfsrt.Alert_SeverityLevel,def=1" json:"severity_level,omitempty"`
...
func (x *Alert) Reset() {
	*x = Alert{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Alert) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{5}
}
...
func (x *TimeRange) Reset() {
	*x = TimeRange{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TimeRange) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{6}
}
...
func (x *Position) Reset() {
	*x = Position{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Position) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{7}
}
...
type TripDescriptor struct {
	...
	ScheduleRelationship *TripDescriptor_ScheduleRelationship `protobuf:"varint,4,opt,name=schedule_relationship,json=scheduleRelationship,enum=njtapi.internal.gtfsrt.TripDescriptor_ScheduleRelationship" json:"schedule_relationship,omitempty"`
...
func (x *TripDescriptor) Reset() {
	*x = TripDescriptor{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TripDescriptor) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{8}
}
...
type VehicleDescriptor struct {
	...
	WheelchairAccessible *VehicleDescriptor_WheelchairAccessible `protobuf:"varint,4,opt,name=wheelchair_accessible,json=wheelchairAccessible,enum=njtapi.internal.gtfsrt.VehicleDescriptor_WheelchairAccessible,def=0" json:"wheelchair_accessible,omitempty"`
	extensionFields      protoimpl.ExtensionFields
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *VehicleDescriptor) Reset() {
	*x = VehicleDescriptor{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*VehicleDescriptor) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{9}
}
...
func (x *EntitySelector) Reset() {
	*x = EntitySelector{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*EntitySelector) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{10}
}
...
func (x *TranslatedString) Reset() {
	*x = TranslatedString{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TranslatedString) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{11}
}
...
func (x *TranslatedImage) Reset() {
	*x = TranslatedImage{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TranslatedImage) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{12}
}
...
func (x *Shape) Reset() {
	*x = Shape{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Shape) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{13}
}
...
type Stop struct {
	...
	WheelchairBoarding *Stop_WheelchairBoarding `protobuf:"varint,13,opt,name=wheelchair_boarding,json=wheelchairBoarding,enum=njtapi.internal.gtfsrt.Stop_WheelchairBoarding,def=0" json:"wheelchair_boarding,omitempty"`
...
func (x *Stop) Reset() {
	*x = Stop{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Stop) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{14}
}
...
func (x *TripModifications) Reset() {
	*x = TripModifications{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TripModifications) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{15}
}
...
func (x *StopSelector) Reset() {
	*x = StopSelector{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StopSelector) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{16}
}
...
func (x *ReplacementStop) Reset() {
	*x = ReplacementStop{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ReplacementStop) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{17}
}
...
func (x *TripUpdate_StopTimeEvent) Reset() {
	*x = TripUpdate_StopTimeEvent{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TripUpdate_StopTimeEvent) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{3, 0}
}
...
type TripUpdate_StopTimeUpdate struct {
	...
	DepartureOccupancyStatus *VehiclePosition_OccupancyStatus                `protobuf:"varint,7,opt,name=departure_occupancy_status,json=departureOccupancyStatus,enum=njtapi.internal.gtfsrt.VehiclePosition_OccupancyStatus" json:"departure_occupancy_status,omitempty"`
	ScheduleRelationship     *TripUpdate_StopTimeUpdate_ScheduleRelationship `protobuf:"varint,5,opt,name=schedule_relationship,json=scheduleRelationship,enum=njtapi.internal.gtfsrt.TripUpdate_StopTimeUpdate_ScheduleRelationship,def=0" json:"schedule_relationship,omitempty"`
...
func (x *TripUpdate_StopTimeUpdate) Reset() {
	*x = TripUpdate_StopTimeUpdate{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TripUpdate_StopTimeUpdate) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{3, 1}
}
...
func (x *TripUpdate_TripProperties) Reset() {
	*x = TripUpdate_TripProperties{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TripUpdate_TripProperties) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{3, 2}
}
...
type TripUpdate_StopTimeUpdate_StopTimeProperties struct {
	...
	// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
	PickupType *TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType `protobuf:"varint,3,opt,name=pickup_type,json=pickupType,enum=njtapi.internal.gtfsrt.TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType" json:"pickup_type,omitempty"`
	// The updated drop off of the vehicle at the stop.
	// NOTE: This field is still experimental, and subject to change. It may be formally adopted in the future.
	DropOffType     *TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType `protobuf:"varint,4,opt,name=drop_off_type,json=dropOffType,enum=njtapi.internal.gtfsrt.TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType" json:"drop_off_type,omitempty"`
	extensionFields protoimpl.ExtensionFields
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *TripUpdate_StopTimeUpdate_StopTimeProperties) Reset() {
	*x = TripUpdate_StopTimeUpdate_StopTimeProperties{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type VehiclePosition_CarriageDetails struct {
	...
	// This message/field is still experimental, and subject to change. It may be formally adopted in the future.
	OccupancyStatus *VehiclePosition_OccupancyStatus `protobuf:"varint,3,opt,name=occupancy_status,json=occupancyStatus,enum=njtapi.internal.gtfsrt.VehiclePosition_OccupancyStatus,def=7" json:"occupancy_status,omitempty"`
...
func (x *VehiclePosition_CarriageDetails) Reset() {
	*x = VehiclePosition_CarriageDetails{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TripDescriptor_ModifiedTripSelector) Reset() {
	*x = TripDescriptor_ModifiedTripSelector{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TranslatedString_Translation) Reset() {
	*x = TranslatedString_Translation{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TranslatedString_Translation) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *TranslatedImage_LocalizedImage) Reset() {
	*x = TranslatedImage_LocalizedImage{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TranslatedImage_LocalizedImage) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{12, 0}
}
...
func (x *TripModifications_Modification) Reset() {
	*x = TripModifications_Modification{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TripModifications_Modification) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{15, 0}
}
...
func (x *TripModifications_SelectedTrips) Reset() {
	*x = TripModifications_SelectedTrips{}
	mi := &file_njtapi_gtfs_realtime_proto_msgTypes[27]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TripModifications_SelectedTrips) Descriptor() ([]byte, []int) {
	return file_njtapi_gtfs_realtime_proto_rawDescGZIP(), []int{15, 1}
}
...
var File_njtapi_gtfs_realtime_proto protoreflect.FileDescriptor

const file_njtapi_gtfs_realtime_proto_rawDesc = "" +
	"\n" +
	"\x1anjtapi_gtfs_realtime.proto\x12\x16njtapi.internal.gtfsrt\"\x95\x01\n" +
	"\vFeedMessage\x12:\n" +
	"\x06header\x18\x01 \x02(\v2\".njtapi.internal.gtfsrt.FeedHeaderR\x06header\x12:\n" +
	"\x06entity\x18\x02 \x03(\v2\".njtapi.internal.gtfsrt.FeedEntityR\x06entity*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xb0\x02\n" +
	"\n" +
	"FeedHeader\x122\n" +
	"\x15gtfs_realtime_version\x18\x01 \x02(\tR\x13gtfsRealtimeVersion\x12g\n" +
	"\x0eincrementality\x18\x02 \x01(\x0e21.njtapi.internal.gtfsrt.FeedHeader.Incrementality:\fFULL_DATASETR\x0eincrementality\x12\x1c\n" +
	...
	"\fDIFFERENTIAL\x10\x01*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xd0\x03\n" +
	"\n" +
	"FeedEntity\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\tR\x02id\x12$\n" +
	"\n" +
	"is_deleted\x18\x02 \x01(\b:\x05falseR\tisDeleted\x12C\n" +
	"\vtrip_update\x18\x03 \x01(\v2\".njtapi.internal.gtfsrt.TripUpdateR\n" +
	"tripUpdate\x12A\n" +
	"\avehicle\x18\x04 \x01(\v2'.njtapi.internal.gtfsrt.VehiclePositionR\avehicle\x123\n" +
	"\x05alert\x18\x05 \x01(\v2\x1d.njtapi.internal.gtfsrt.AlertR\x05alert\x123\n" +
	"\x05shape\x18\x06 \x01(\v2\x1d.njtapi.internal.gtfsrt.ShapeR\x05shape\x120\n" +
	"\x04stop\x18\a \x01(\v2\x1c.njtapi.internal.gtfsrt.StopR\x04stop\x12X\n" +
	"\x12trip_modifications\x18\b \x01(\v2).njtapi.internal.gtfsrt.TripModificationsR\x11tripModifications*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\x8d\x0f\n" +
	"\n" +
	"TripUpdate\x12:\n" +
	"\x04trip\x18\x01 \x02(\v2&.njtapi.internal.gtfsrt.TripDescriptorR\x04trip\x12C\n" +
	"\avehicle\x18\x03 \x01(\v2).njtapi.internal.gtfsrt.VehicleDescriptorR\avehicle\x12[\n" +
	"\x10stop_time_update\x18\x02 \x03(\v21.njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdateR\x0estopTimeUpdate\x12\x1c\n" +
	"\ttimestamp\x18\x04 \x01(\x04R\ttimestamp\x12\x14\n" +
	"\x05delay\x18\x05 \x01(\x05R\x05delay\x12Z\n" +
	"\x0ftrip_properties\x18\x06 \x01(\v21.njtapi.internal.gtfsrt.TripUpdate.TripPropertiesR\x0etripProperties\x1a\x92\x01\n" +
	...
	"\x0escheduled_time\x18\x04 \x01(\x03R\rscheduledTime*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\x1a\x89\t\n" +
	"\x0eStopTimeUpdate\x12#\n" +
	"\rstop_sequence\x18\x01 \x01(\rR\fstopSequence\x12\x17\n" +
	"\astop_id\x18\x04 \x01(\tR\x06stopId\x12J\n" +
	"\aarrival\x18\x02 \x01(\v20.njtapi.internal.gtfsrt.TripUpdate.StopTimeEventR\aarrival\x12N\n" +
	"\tdeparture\x18\x03 \x01(\v20.njtapi.internal.gtfsrt.TripUpdate.StopTimeEventR\tdeparture\x12u\n" +
	"\x1adeparture_occupancy_status\x18\a \x01(\x0e27.njtapi.internal.gtfsrt.VehiclePosition.OccupancyStatusR\x18departureOccupancyStatus\x12\x86\x01\n" +
	"\x15schedule_relationship\x18\x05 \x01(\x0e2F.njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.ScheduleRelationship:\tSCHEDULEDR\x14scheduleRelationship\x12v\n" +
	"\x14stop_time_properties\x18\x06 \x01(\v2D.njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimePropertiesR\x12stopTimeProperties\x1a\xc2\x03\n" +
	"\x12StopTimeProperties\x12(\n" +
	"\x10assigned_stop_id\x18\x01 \x01(\tR\x0eassignedStopId\x12#\n" +
	"\rstop_headsign\x18\x02 \x01(\tR\fstopHeadsign\x12w\n" +
	"\vpickup_type\x18\x03 \x01(\x0e2V.njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties.DropOffPickupTypeR\n" +
	"pickupType\x12z\n" +
	"\rdrop_off_type\x18\x04 \x01(\x0e2V.njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties.DropOffPickupTypeR\vdropOffType\"X\n" +
	...
	"\x0ftrip_short_name\x18\x06 \x01(\tR\rtripShortName*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xef\v\n" +
	"\x0fVehiclePosition\x12:\n" +
	"\x04trip\x18\x01 \x01(\v2&.njtapi.internal.gtfsrt.TripDescriptorR\x04trip\x12C\n" +
	"\avehicle\x18\b \x01(\v2).njtapi.internal.gtfsrt.VehicleDescriptorR\avehicle\x12<\n" +
	"\bposition\x18\x02 \x01(\v2 .njtapi.internal.gtfsrt.PositionR\bposition\x122\n" +
	"\x15current_stop_sequence\x18\x03 \x01(\rR\x13currentStopSequence\x12\x17\n" +
	"\astop_id\x18\a \x01(\tR\x06stopId\x12o\n" +
	"\x0ecurrent_status\x18\x04 \x01(\x0e29.njtapi.internal.gtfsrt.VehiclePosition.VehicleStopStatus:\rIN_TRANSIT_TOR\rcurrentStatus\x12\x1c\n" +
	"\ttimestamp\x18\x05 \x01(\x04R\ttimestamp\x12b\n" +
	"\x10congestion_level\x18\x06 \x01(\x0e27.njtapi.internal.gtfsrt.VehiclePosition.CongestionLevelR\x0fcongestionLevel\x12b\n" +
	"\x10occupancy_status\x18\t \x01(\x0e27.njtapi.internal.gtfsrt.VehiclePosition.OccupancyStatusR\x0foccupancyStatus\x121\n" +
	"\x14occupancy_percentage\x18\n" +
	" \x01(\rR\x13occupancyPercentage\x12m\n" +
	"\x16multi_carriage_details\x18\v \x03(\v27.njtapi.internal.gtfsrt.VehiclePosition.CarriageDetailsR\x14multiCarriageDetails\x1a\xa2\x02\n" +
	"\x0fCarriageDetails\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12u\n" +
	"\x10occupancy_status\x18\x03 \x01(\x0e27.njtapi.internal.gtfsrt.VehiclePosition.OccupancyStatus:\x11NO_DATA_AVAILABLER\x0foccupancyStatus\x125\n" +
	...
	"\rNOT_BOARDABLE\x10\b*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xad\x0e\n" +
	"\x05Alert\x12J\n" +
	"\ractive_period\x18\x01 \x03(\v2!.njtapi.internal.gtfsrt.TimeRangeB\x02\x18\x01R\factivePeriod\x12T\n" +
	"\x14communication_period\x18\x02 \x03(\v2!.njtapi.internal.gtfsrt.TimeRangeR\x13communicationPeriod\x12F\n" +
	"\rimpact_period\x18\x03 \x03(\v2!.njtapi.internal.gtfsrt.TimeRangeR\fimpactPeriod\x12O\n" +
	"\x0finformed_entity\x18\x05 \x03(\v2&.njtapi.internal.gtfsrt.EntitySelectorR\x0einformedEntity\x12H\n" +
	"\x05cause\x18\x06 \x01(\x0e2#.njtapi.internal.gtfsrt.Alert.Cause:\rUNKNOWN_CAUSER\x05cause\x12L\n" +
	"\x06effect\x18\a \x01(\x0e2$.njtapi.internal.gtfsrt.Alert.Effect:\x0eUNKNOWN_EFFECTR\x06effect\x12:\n" +
	"\x03url\x18\b \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\x03url\x12I\n" +
	"\vheader_text\x18\n" +
	" \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\n" +
	"headerText\x12S\n" +
	"\x10description_text\x18\v \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\x0fdescriptionText\x12P\n" +
	"\x0ftts_header_text\x18\f \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\rttsHeaderText\x12Z\n" +
	"\x14tts_description_text\x18\r \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\x12ttsDescriptionText\x12d\n" +
	"\x0eseverity_level\x18\x0e \x01(\x0e2+.njtapi.internal.gtfsrt.Alert.SeverityLevel:\x10UNKNOWN_SEVERITYR\rseverityLevel\x12=\n" +
	"\x05image\x18\x0f \x01(\v2'.njtapi.internal.gtfsrt.TranslatedImageR\x05image\x12^\n" +
	"\x16image_alternative_text\x18\x10 \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\x14imageAlternativeText\x12K\n" +
	"\fcause_detail\x18\x11 \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\vcauseDetail\x12M\n" +
	"\reffect_detail\x18\x12 \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\feffectDetail\"\xeb\x01\n" +
	"\x05Cause\x12\x11\n" +
	...
	"\x11MEDICAL_EMERGENCY\x10\f\x12\x11\n" +
	...
	"\x05speed\x18\x05 \x01(\x02R\x05speed*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xd2\x05\n" +
	...
	"\n" +
	"start_date\x18\x03 \x01(\tR\tstartDate\x12p\n" +
	"\x15schedule_relationship\x18\x04 \x01(\x0e2;.njtapi.internal.gtfsrt.TripDescriptor.ScheduleRelationshipR\x14scheduleRelationship\x12`\n" +
	"\rmodified_trip\x18\a \x01(\v2;.njtapi.internal.gtfsrt.TripDescriptor.ModifiedTripSelectorR\fmodifiedTrip\x1a\xb9\x01\n" +
	...
	"\x03NEW\x10\b*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xd8\x02\n" +
	"\x11VehicleDescriptor\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05label\x18\x02 \x01(\tR\x05label\x12#\n" +
	"\rlicense_plate\x18\x03 \x01(\tR\flicensePlate\x12}\n" +
	"\x15wheelchair_accessible\x18\x04 \x01(\x0e2>.njtapi.internal.gtfsrt.VehicleDescriptor.WheelchairAccessible:\bNO_VALUER\x14wheelchairAccessible\"i\n" +
	"\x14WheelchairAccessible\x12\f\n" +
	"\bNO_VALUE\x10\x00\x12\v\n" +
	"\aUNKNOWN\x10\x01\x12\x19\n" +
	"\x15WHEELCHAIR_ACCESSIBLE\x10\x02\x12\x1b\n" +
	"\x17WHEELCHAIR_INACCESSIBLE\x10\x03*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xef\x01\n" +
	...
	"\x04trip\x18\x04 \x01(\v2&.njtapi.internal.gtfsrt.TripDescriptorR\x04trip\x12\x17\n" +
	"\astop_id\x18\x05 \x01(\tR\x06stopId\x12!\n" +
	"\fdirection_id\x18\x06 \x01(\rR\vdirectionId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xc9\x01\n" +
	"\x10TranslatedString\x12V\n" +
	"\vtranslation\x18\x01 \x03(\v24.njtapi.internal.gtfsrt.TranslatedString.TranslationR\vtranslation\x1aM\n" +
	"\vTranslation\x12\x12\n" +
	"\x04text\x18\x01 \x02(\tR\x04text\x12\x1a\n" +
	"\blanguage\x18\x02 \x01(\tR\blanguage*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xf1\x01\n" +
	"\x0fTranslatedImage\x12_\n" +
	"\x0flocalized_image\x18\x01 \x03(\v26.njtapi.internal.gtfsrt.TranslatedImage.LocalizedImageR\x0elocalizedImage\x1am\n" +
	...
	"\x10encoded_polyline\x18\x02 \x01(\tR\x0fencodedPolyline*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xcc\x06\n" +
	"\x04Stop\x12\x17\n" +
	"\astop_id\x18\x01 \x01(\tR\x06stopId\x12E\n" +
	"\tstop_code\x18\x02 \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\bstopCode\x12E\n" +
	"\tstop_name\x18\x03 \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\bstopName\x12L\n" +
	"\rtts_stop_name\x18\x04 \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\vttsStopName\x12E\n" +
	"\tstop_desc\x18\x05 \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\bstopDesc\x12\x19\n" +
	"\bstop_lat\x18\x06 \x01(\x02R\astopLat\x12\x19\n" +
	"\bstop_lon\x18\a \x01(\x02R\astopLon\x12\x17\n" +
	"\azone_id\x18\b \x01(\tR\x06zoneId\x12C\n" +
	"\bstop_url\x18\t \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\astopUrl\x12%\n" +
	"\x0eparent_station\x18\v \x01(\tR\rparentStation\x12#\n" +
	"\rstop_timezone\x18\f \x01(\tR\fstopTimezone\x12i\n" +
	"\x13wheelchair_boarding\x18\r \x01(\x0e2/.njtapi.internal.gtfsrt.Stop.WheelchairBoarding:\aUNKNOWNR\x12wheelchairBoarding\x12\x19\n" +
	"\blevel_id\x18\x0e \x01(\tR\alevelId\x12M\n" +
	"\rplatform_code\x18\x0f \x01(\v2(.njtapi.internal.gtfsrt.TranslatedStringR\fplatformCode\"C\n" +
	"\x12WheelchairBoarding\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\r\n" +
	"\tAVAILABLE\x10\x01\x12\x11\n" +
	"\rNOT_AVAILABLE\x10\x02*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90N\"\xbc\x06\n" +
	"\x11TripModifications\x12^\n" +
	"\x0eselected_trips\x18\x01 \x03(\v27.njtapi.internal.gtfsrt.TripModifications.SelectedTripsR\rselectedTrips\x12\x1f\n" +
	"\vstart_times\x18\x02 \x03(\tR\n" +
	"startTimes\x12#\n" +
	"\rservice_dates\x18\x03 \x03(\tR\fserviceDates\x12\\\n" +
	"\rmodifications\x18\x04 \x03(\v26.njtapi.internal.gtfsrt.TripModifications.ModificationR\rmodifications\x1a\xbb\x03\n" +
	"\fModification\x12T\n" +
	"\x13start_stop_selector\x18\x01 \x01(\v2$.njtapi.internal.gtfsrt.StopSelectorR\x11startStopSelector\x12P\n" +
	"\x11end_stop_selector\x18\x02 \x01(\v2$.njtapi.internal.gtfsrt.StopSelectorR\x0fendStopSelector\x12E\n" +
	"\x1dpropagated_modification_delay\x18\x03 \x01(\x05:\x010R\x1bpropagatedModificationDelay\x12T\n" +
	"\x11replacement_stops\x18\x04 \x03(\v2'.njtapi.internal.gtfsrt.ReplacementStopR\x10replacementStops\x12(\n" +
	...
	"\astop_id\x18\x02 \x01(\tR\x06stopId*\x06\b\xe8\a\x10\xd0\x0f*\x06\b\xa8F\x10\x90NBG\n" +
	"\x1bcom.google.transit.realtimeZ(github.com/bamnet/njtapi/internal/gtfsrt"

var (
	file_njtapi_gtfs_realtime_proto_rawDescOnce sync.Once
	file_njtapi_gtfs_realtime_proto_rawDescData []byte
)

func file_njtapi_gtfs_realtime_proto_rawDescGZIP() []byte {
	file_njtapi_gtfs_realtime_proto_rawDescOnce.Do(func() {
		file_njtapi_gtfs_realtime_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_njtapi_gtfs_realtime_proto_rawDesc), len(file_njtapi_gtfs_realtime_proto_rawDesc)))
	})
	return file_njtapi_gtfs_realtime_proto_rawDescData
}

var file_njtapi_gtfs_realtime_proto_enumTypes = make([]protoimpl.EnumInfo, 12)
var file_njtapi_gtfs_realtime_proto_msgTypes = make([]protoimpl.MessageInfo, 28)
var file_njtapi_gtfs_realtime_proto_goTypes = []any{
	(FeedHeader_Incrementality)(0),                                      // 0: njtapi.internal.gtfsrt.FeedHeader.Incrementality
	(TripUpdate_StopTimeUpdate_ScheduleRelationship)(0),                 // 1: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.ScheduleRelationship
	(TripUpdate_StopTimeUpdate_StopTimeProperties_DropOffPickupType)(0), // 2: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties.DropOffPickupType
	(VehiclePosition_VehicleStopStatus)(0),                              // 3: njtapi.internal.gtfsrt.VehiclePosition.VehicleStopStatus
	(VehiclePosition_CongestionLevel)(0),                                // 4: njtapi.internal.gtfsrt.VehiclePosition.CongestionLevel
	(VehiclePosition_OccupancyStatus)(0),                                // 5: njtapi.internal.gtfsrt.VehiclePosition.OccupancyStatus
	(Alert_Cause)(0),                                                    // 6: njtapi.internal.gtfsrt.Alert.Cause
	(Alert_Effect)(0),                                                   // 7: njtapi.internal.gtfsrt.Alert.Effect
	(Alert_SeverityLevel)(0),                                            // 8: njtapi.internal.gtfsrt.Alert.SeverityLevel
	(TripDescriptor_ScheduleRelationship)(0),                            // 9: njtapi.internal.gtfsrt.TripDescriptor.ScheduleRelationship
	(VehicleDescriptor_WheelchairAccessible)(0),                         // 10: njtapi.internal.gtfsrt.VehicleDescriptor.WheelchairAccessible
	(Stop_WheelchairBoarding)(0),                                        // 11: njtapi.internal.gtfsrt.Stop.WheelchairBoarding
	(*FeedMessage)(nil),                                                 // 12: njtapi.internal.gtfsrt.FeedMessage
	(*FeedHeader)(nil),                                                  // 13: njtapi.internal.gtfsrt.FeedHeader
	(*FeedEntity)(nil),                                                  // 14: njtapi.internal.gtfsrt.FeedEntity
	(*TripUpdate)(nil),                                                  // 15: njtapi.internal.gtfsrt.TripUpdate
	(*VehiclePosition)(nil),                                             // 16: njtapi.internal.gtfsrt.VehiclePosition
	(*Alert)(nil),                                                       // 17: njtapi.internal.gtfsrt.Alert
	(*TimeRange)(nil),                                                   // 18: njtapi.internal.gtfsrt.TimeRange
	(*Position)(nil),                                                    // 19: njtapi.internal.gtfsrt.Position
	(*TripDescriptor)(nil),                                              // 20: njtapi.internal.gtfsrt.TripDescriptor
	(*VehicleDescriptor)(nil),                                           // 21: njtapi.internal.gtfsrt.VehicleDescriptor
	(*EntitySelector)(nil),                                              // 22: njtapi.internal.gtfsrt.EntitySelector
	(*TranslatedString)(nil),                                            // 23: njtapi.internal.gtfsrt.TranslatedString
	(*TranslatedImage)(nil),                                             // 24: njtapi.internal.gtfsrt.TranslatedImage
	(*Shape)(nil),                                                       // 25: njtapi.internal.gtfsrt.Shape
	(*Stop)(nil),                                                        // 26: njtapi.internal.gtfsrt.Stop
	(*TripModifications)(nil),                                           // 27: njtapi.internal.gtfsrt.TripModifications
	(*StopSelector)(nil),                                                // 28: njtapi.internal.gtfsrt.StopSelector
	(*ReplacementStop)(nil),                                             // 29: njtapi.internal.gtfsrt.ReplacementStop
	(*TripUpdate_StopTimeEvent)(nil),                                    // 30: njtapi.internal.gtfsrt.TripUpdate.StopTimeEvent
	(*TripUpdate_StopTimeUpdate)(nil),                                   // 31: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate
	(*TripUpdate_TripProperties)(nil),                                   // 32: njtapi.internal.gtfsrt.TripUpdate.TripProperties
	(*TripUpdate_StopTimeUpdate_StopTimeProperties)(nil),                // 33: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties
	(*VehiclePosition_CarriageDetails)(nil),                             // 34: njtapi.internal.gtfsrt.VehiclePosition.CarriageDetails
	(*TripDescriptor_ModifiedTripSelector)(nil),                         // 35: njtapi.internal.gtfsrt.TripDescriptor.ModifiedTripSelector
	(*TranslatedString_Translation)(nil),                                // 36: njtapi.internal.gtfsrt.TranslatedString.Translation
	(*TranslatedImage_LocalizedImage)(nil),                              // 37: njtapi.internal.gtfsrt.TranslatedImage.LocalizedImage
	(*TripModifications_Modification)(nil),                              // 38: njtapi.internal.gtfsrt.TripModifications.Modification
	(*TripModifications_SelectedTrips)(nil),                             // 39: njtapi.internal.gtfsrt.TripModifications.SelectedTrips
}
var file_njtapi_gtfs_realtime_proto_depIdxs = []int32{
	13, // 0: njtapi.internal.gtfsrt.FeedMessage.header:type_name -> njtapi.internal.gtfsrt.FeedHeader
	14, // 1: njtapi.internal.gtfsrt.FeedMessage.entity:type_name -> njtapi.internal.gtfsrt.FeedEntity
	0,  // 2: njtapi.internal.gtfsrt.FeedHeader.incrementality:type_name -> njtapi.internal.gtfsrt.FeedHeader.Incrementality
	15, // 3: njtapi.internal.gtfsrt.FeedEntity.trip_update:type_name -> njtapi.internal.gtfsrt.TripUpdate
	16, // 4: njtapi.internal.gtfsrt.FeedEntity.vehicle:type_name -> njtapi.internal.gtfsrt.VehiclePosition
	17, // 5: njtapi.internal.gtfsrt.FeedEntity.alert:type_name -> njtapi.internal.gtfsrt.Alert
	25, // 6: njtapi.internal.gtfsrt.FeedEntity.shape:type_name -> njtapi.internal.gtfsrt.Shape
	26, // 7: njtapi.internal.gtfsrt.FeedEntity.stop:type_name -> njtapi.internal.gtfsrt.Stop
	27, // 8: njtapi.internal.gtfsrt.FeedEntity.trip_modifications:type_name -> njtapi.internal.gtfsrt.TripModifications
	20, // 9: njtapi.internal.gtfsrt.TripUpdate.trip:type_name -> njtapi.internal.gtfsrt.TripDescriptor
	21, // 10: njtapi.internal.gtfsrt.TripUpdate.vehicle:type_name -> njtapi.internal.gtfsrt.VehicleDescriptor
	31, // 11: njtapi.internal.gtfsrt.TripUpdate.stop_time_update:type_name -> njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate
	32, // 12: njtapi.internal.gtfsrt.TripUpdate.trip_properties:type_name -> njtapi.internal.gtfsrt.TripUpdate.TripProperties
	20, // 13: njtapi.internal.gtfsrt.VehiclePosition.trip:type_name -> njtapi.internal.gtfsrt.TripDescriptor
	21, // 14: njtapi.internal.gtfsrt.VehiclePosition.vehicle:type_name -> njtapi.internal.gtfsrt.VehicleDescriptor
	19, // 15: njtapi.internal.gtfsrt.VehiclePosition.position:type_name -> njtapi.internal.gtfsrt.Position
	3,  // 16: njtapi.internal.gtfsrt.VehiclePosition.current_status:type_name -> njtapi.internal.gtfsrt.VehiclePosition.VehicleStopStatus
	4,  // 17: njtapi.internal.gtfsrt.VehiclePosition.congestion_level:type_name -> njtapi.internal.gtfsrt.VehiclePosition.CongestionLevel
	5,  // 18: njtapi.internal.gtfsrt.VehiclePosition.occupancy_status:type_name -> njtapi.internal.gtfsrt.VehiclePosition.OccupancyStatus
	34, // 19: njtapi.internal.gtfsrt.VehiclePosition.multi_carriage_details:type_name -> njtapi.internal.gtfsrt.VehiclePosition.CarriageDetails
	18, // 20: njtapi.internal.gtfsrt.Alert.active_period:type_name -> njtapi.internal.gtfsrt.TimeRange
	18, // 21: njtapi.internal.gtfsrt.Alert.communication_period:type_name -> njtapi.internal.gtfsrt.TimeRange
	18, // 22: njtapi.internal.gtfsrt.Alert.impact_period:type_name -> njtapi.internal.gtfsrt.TimeRange
	22, // 23: njtapi.internal.gtfsrt.Alert.informed_entity:type_name -> njtapi.internal.gtfsrt.EntitySelector
	6,  // 24: njtapi.internal.gtfsrt.Alert.cause:type_name -> njtapi.internal.gtfsrt.Alert.Cause
	7,  // 25: njtapi.internal.gtfsrt.Alert.effect:type_name -> njtapi.internal.gtfsrt.Alert.Effect
	23, // 26: njtapi.internal.gtfsrt.Alert.url:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 27: njtapi.internal.gtfsrt.Alert.header_text:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 28: njtapi.internal.gtfsrt.Alert.description_text:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 29: njtapi.internal.gtfsrt.Alert.tts_header_text:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 30: njtapi.internal.gtfsrt.Alert.tts_description_text:type_name -> njtapi.internal.gtfsrt.TranslatedString
	8,  // 31: njtapi.internal.gtfsrt.Alert.severity_level:type_name -> njtapi.internal.gtfsrt.Alert.SeverityLevel
	24, // 32: njtapi.internal.gtfsrt.Alert.image:type_name -> njtapi.internal.gtfsrt.TranslatedImage
	23, // 33: njtapi.internal.gtfsrt.Alert.image_alternative_text:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 34: njtapi.internal.gtfsrt.Alert.cause_detail:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 35: njtapi.internal.gtfsrt.Alert.effect_detail:type_name -> njtapi.internal.gtfsrt.TranslatedString
	9,  // 36: njtapi.internal.gtfsrt.TripDescriptor.schedule_relationship:type_name -> njtapi.internal.gtfsrt.TripDescriptor.ScheduleRelationship
	35, // 37: njtapi.internal.gtfsrt.TripDescriptor.modified_trip:type_name -> njtapi.internal.gtfsrt.TripDescriptor.ModifiedTripSelector
	10, // 38: njtapi.internal.gtfsrt.VehicleDescriptor.wheelchair_accessible:type_name -> njtapi.internal.gtfsrt.VehicleDescriptor.WheelchairAccessible
	20, // 39: njtapi.internal.gtfsrt.EntitySelector.trip:type_name -> njtapi.internal.gtfsrt.TripDescriptor
	36, // 40: njtapi.internal.gtfsrt.TranslatedString.translation:type_name -> njtapi.internal.gtfsrt.TranslatedString.Translation
	37, // 41: njtapi.internal.gtfsrt.TranslatedImage.localized_image:type_name -> njtapi.internal.gtfsrt.TranslatedImage.LocalizedImage
	23, // 42: njtapi.internal.gtfsrt.Stop.stop_code:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 43: njtapi.internal.gtfsrt.Stop.stop_name:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 44: njtapi.internal.gtfsrt.Stop.tts_stop_name:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 45: njtapi.internal.gtfsrt.Stop.stop_desc:type_name -> njtapi.internal.gtfsrt.TranslatedString
	23, // 46: njtapi.internal.gtfsrt.Stop.stop_url:type_name -> njtapi.internal.gtfsrt.TranslatedString
	11, // 47: njtapi.internal.gtfsrt.Stop.wheelchair_boarding:type_name -> njtapi.internal.gtfsrt.Stop.WheelchairBoarding
	23, // 48: njtapi.internal.gtfsrt.Stop.platform_code:type_name -> njtapi.internal.gtfsrt.TranslatedString
	39, // 49: njtapi.internal.gtfsrt.TripModifications.selected_trips:type_name -> njtapi.internal.gtfsrt.TripModifications.SelectedTrips
	38, // 50: njtapi.internal.gtfsrt.TripModifications.modifications:type_name -> njtapi.internal.gtfsrt.TripModifications.Modification
	30, // 51: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.arrival:type_name -> njtapi.internal.gtfsrt.TripUpdate.StopTimeEvent
	30, // 52: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.departure:type_name -> njtapi.internal.gtfsrt.TripUpdate.StopTimeEvent
	5,  // 53: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.departure_occupancy_status:type_name -> njtapi.internal.gtfsrt.VehiclePosition.OccupancyStatus
	1,  // 54: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.schedule_relationship:type_name -> njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.ScheduleRelationship
	33, // 55: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.stop_time_properties:type_name -> njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties
	2,  // 56: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties.pickup_type:type_name -> njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties.DropOffPickupType
	2,  // 57: njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties.drop_off_type:type_name -> njtapi.internal.gtfsrt.TripUpdate.StopTimeUpdate.StopTimeProperties.DropOffPickupType
	5,  // 58: njtapi.internal.gtfsrt.VehiclePosition.CarriageDetails.occupancy_status:type_name -> njtapi.internal.gtfsrt.VehiclePosition.OccupancyStatus
	28, // 59: njtapi.internal.gtfsrt.TripModifications.Modification.start_stop_selector:type_name -> njtapi.internal.gtfsrt.StopSelector
	28, // 60: njtapi.internal.gtfsrt.TripModifications.Modification.end_stop_selector:type_name -> njtapi.internal.gtfsrt.StopSelector
	29, // 61: njtapi.internal.gtfsrt.TripModifications.Modification.replacement_stops:type_name -> njtapi.internal.gtfsrt.ReplacementStop
...
func init() { file_njtapi_gtfs_realtime_proto_init() }
func file_njtapi_gtfs_realtime_proto_init() {
	if File_njtapi_gtfs_realtime_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_njtapi_gtfs_realtime_proto_rawDesc), len(file_njtapi_gtfs_realtime_proto_rawDesc)),
			NumEnums:      12,
			NumMessages:   28,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_njtapi_gtfs_realtime_proto_goTypes,
		DependencyIndexes: file_njtapi_gtfs_realtime_proto_depIdxs,
		EnumInfos:         file_njtapi_gtfs_realtime_proto_enumTypes,
		MessageInfos:      file_njtapi_gtfs_realtime_proto_msgTypes,
	}.Build()
	File_njtapi_gtfs_realtime_proto = out.File
	file_njtapi_gtfs_realtime_proto_goTypes = nil
	file_njtapi_gtfs_realtime_proto_depIdxs = nil
}
