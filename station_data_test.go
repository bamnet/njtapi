				...
				Departures: []StationTrain{
					{
						...
						InlineMsg:              "",
						Stops: []StationStop{
							{Name: "New York Penn Station", Time: time.Date(2019, 11, 18, 20, 7, 0, 0, loc), Departed: true, Status: "BOARDING"},
							{Name: "Secaucus Upper Lvl", Time: time.Date(2019, 11, 18, 20, 20, 30, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Newark Penn Station", Time: time.Date(2019, 11, 18, 20, 28, 45, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Newark Airport", Time: time.Date(2019, 11, 18, 20, 35, 0, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "North Elizabeth", Time: time.Date(2019, 11, 18, 20, 38, 45, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Elizabeth", Time: time.Date(2019, 11, 18, 20, 41, 30, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Linden", Time: time.Date(2019, 11, 18, 20, 46, 45, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Rahway", Time: time.Date(2019, 11, 18, 20, 51, 00, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Metropark", Time: time.Date(2019, 11, 18, 20, 59, 45, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Metuchen", Time: time.Date(2019, 11, 18, 21, 04, 15, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Edison", Time: time.Date(2019, 11, 18, 21, 9, 15, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "New Brunswick", Time: time.Date(2019, 11, 18, 21, 13, 30, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Jersey Avenue", Time: time.Date(2019, 11, 18, 21, 18, 15, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Princeton Junction", Time: time.Date(2019, 11, 18, 21, 30, 45, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Hamilton", Time: time.Date(2019, 11, 18, 21, 37, 15, 0, loc), Departed: false, Status: "OnTime"},
							{Name: "Trenton", Time: time.Date(2019, 11, 18, 21, 50, 15, 0, loc), Departed: false, Status: "OnTime"},
						},
					}, {
						Index:                  1,
						TrainID:                3283,
						...
						InlineMsg:              "",
						Stops: []StationStop{
							{Name: "New York Penn Station", Time: time.Date(2019, 11, 18, 20, 22, 0, 0, loc), Departed: false, Status: "BOARDING"},
